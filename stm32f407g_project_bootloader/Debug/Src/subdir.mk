...
clean-Src:
	-$(RM) ./Src/bootloader.cyclo ./Src/bootloader.d ./Src/bootloader.o ./Src/bootloader.su ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
